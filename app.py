...
st.set_page_config(page_title='Weather Prediction',layout='centered',initial_sidebar_state='expanded')
st.title(" 🌦️ Weather Prediction ")

st.divider()

with st.popover("ℹ️ About Weather Prediction Project",use_container_width=True) :

    st.header("📖 About Project")

    st.write(
        """
        **Weather Prediction** is a deep learning
...
st.divider()
st.caption(""" 🌦️ Weather Prediction | ⚛ Deep Learning Project  
